...
function App() {
  ...
  const services = [

    {
      ...
      description: 'نقدم خدمات تخليص جمركي احترافية وسريعة لجميع أنواع البضائع، مع فريق مخلص جمركي متخصص يضمن الامتثال الكامل للقوانين واللوائح الجمركية في السعودية. نحن نوفر حلول جمركية متكاملة لضمان سلاسة استيراد وتصدير بضائعك. كما نقدم خدمات التخليص الجمركي في مصر والإمارات، ونوفر معلومات عن اسعار التخليص الجمركي وكيفية التخليص الجمركي للبضائع وخطوات التخليص الجمركي في السعودية. نحن افضل مكتب تخليص جمركي بالرياض وجدة والدمام. سليمان الحويطي، سليمان الحويطي للتخليص، مكتب سليمان الحويطي.',
    ...
    },
    {
      icon: shippingIcon,
      title: 'الشحن البحري',
      description: 'نقدم حلول شحن بحري وجوي وبري متكاملة، مع تتبع مباشر وأسعار تنافسية لجميع الوجهات العالمية. نضمن نقل بضائعك بأمان وفعالية، ونوفر خدمات لوجستية شاملة لعمليات الشحن الدولي والترانزيت الدولي. كما نغطي تكلفة التخليص الجمركي للحاويات وشركات التخليص الجمركي المعتمدة في الموانئ.',
    ...
    },
    {
      ...
      description: 'إدارة شاملة لعمليات الاستيراد والتصدير، مع استشارات متخصصة وحلول مخصصة لضمان سلاسة التجارة الدولية. نقدم دعمًا قانونيًا ولوجستيًا لجميع متطلبات الاستيراد والتصدير، بما في ذلك اجراءات التخليص الجمركي للاستيراد والتصدير والتخليص الجمركي للشحنات الجوية والبحرية. نحن دليل مخلصين جمركيين معتمدين ونتعامل مع الجمارك السعودية والجمارك المصرية والهيئة العامة للجمارك ورسوم الجمارك، ونعمل كمخلص معتمد في تخليص جمركي جدة، مخلص جمركي الرياض، ومخلص جمركي ضبا.',
  ...
  const whyUs = [
    {
      icon: Globe,
      title: 'خبرة عالمية',
      description: 'سنوات طويلة من الخبرة في التعامل مع مختلف الشحنات واللوائح الجمركية الدولية.'
    },
    {
      icon: Clock,
      title: 'سرعة ودقة',
      description: 'نضمن إنجاز معاملاتك بأقصى سرعة ودقة، لتوفير وقتك وجهدك.'
    },
    {
      icon: Shield,
      title: 'أمان وموثوقية',
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {/* قسم الخدمات المحسن */}
      <section id="services" className="py-20 bg-gradient-to-b from-slate-900 to-slate-800 relative scroll-mt-[70px]">
